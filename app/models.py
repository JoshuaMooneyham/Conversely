...
<<<<<<< HEAD
    banned_users = models.ManyToManyField(User, related_name='banned_from', null=True, blank=True)
=======
...
<<<<<<< HEAD
    blocked_users = models.ManyToManyField(User, related_name='blocked_by', null=True, blank=True)
=======
